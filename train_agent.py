...
model = PPO(
    "MlpPolicy", # Multi-Layer Perceptron policy (standard feedforward network)
    env, 
    verbose=1, 
    learning_rate=0.0003,
    gamma=0.99, # Discount factor
    tensorboard_log=LOG_DIR, # Enable logging to TensorBoard
)
...
# --- 4. TEST AND RENDER (Optional) ---

# Reload a simple environment for testing (non-vectorized)
